Shader "Custom/Palette_Colorblind"
{
    Properties 
    {
...
float3(0,0,0)//black
            ...
            fixed4 frag (v2f i) : SV_Target { // Fragment Shader
				...
				for (int i = 0; i < 256; i++)
				{
				    float dist = abs(color_tex.r - c_205[i].r/256) + abs(color_tex.g - c_205[i].g/256) + abs(color_tex.b - c_205[i].b/256);
				    if (dist < min_dist)
				    {
				        min_dist = dist;
						best_color = i;
				...
				color_out = fixed4(c_205[best_color].r/256,c_205[best_color].g/256,c_205[best_color].b/256,1);
                color_out = color_out + 0.05;
				return color_out;
            }
            ENDCG
        }
